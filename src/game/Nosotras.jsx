  ...
  return (
    <div className="instructions-container">
      ...
      <section>
        <h2>¿Quiénes somos?</h2>
        <p>
          Somos tres amigas que se encuentran desarrollando su proyecto de Tecnología y aplicaciones Web.
        ...
        <p>
          Este proyecto nació de la idea de combinar la emoción de la cocina con el desafío de la programación.
